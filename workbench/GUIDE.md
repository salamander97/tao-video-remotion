...
本页按界面区域介绍每个功能。接入契约与制作规范见 [vendor/shotcraft/workbench.md](../vendor/shotcraft/workbench.md)，
...
- **BGM 备选**（4 条）与**音效库**（144 条，按 camera / counter / crowd… 共 15 类折叠）来自仓库 `assets/audio/`。
...
- 让自己的成片能被逐属性编辑：镜头组件把语境参数做成 props + schema、写一份 `src/workbench.ts` 清单，见 [vendor/shotcraft/workbench.md](../vendor/shotcraft/workbench.md) §2–§3。
